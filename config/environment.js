...
module.exports = function(environment) {
  var ENV = {
    ...
    APP: {
      ...
      apiServer: 'http://47.52.16.87:8080/',
      // monitoringApiServer: 'http://localhost:8888',
      // loggingApiServer: 'http://localhost:8090',
      monitoringApiServer: 'http://47.89.14.205:31651',
      esApiServer: 'http://47.52.113.251:30032/',
      esEndpoint: '/es',
      monitoringEndpoint: '/v5',
      loggingEndpoint: '/v6',
      loggingApiServer: 'http://47.89.14.205:30090',
